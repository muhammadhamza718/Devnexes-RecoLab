...
def test_session_manager_onboarding():
    ...
    assert SessionManager.get_onboarding_selected_genres() == []
    assert SessionManager.get_onboarding_liked_movies() == []

    SessionManager.set_onboarding_selected_genres(["Action", "Comedy"])
    assert SessionManager.get_onboarding_selected_genres() == ["Action", "Comedy"]
...
def test_wizard_controller():
    ...
    # Advance to step 1
    SessionManager.set_onboarding_selected_genres(["Action"])
    ...
    assert len(SessionManager.get_onboarding_selected_genres()) > 0
